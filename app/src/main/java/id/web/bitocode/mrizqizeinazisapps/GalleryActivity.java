    ...
    nv.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener()
    {
      ...
      public boolean onNavigationItemSelected(@NonNull MenuItem menuItem)
      {
        ...
        switch (id)
        {
          ...
          case R.id.navfriend:
            Toast.makeText(GalleryActivity.this, "Friend",Toast.LENGTH_SHORT).show();
            break;
          ...
          case R.id.navmusic:
            Toast.makeText(GalleryActivity.this, "Music",Toast.LENGTH_SHORT).show();
        
          case R.id.navprofile:
            Toast.makeText(GalleryActivity.this, "Profile",Toast.LENGTH_SHORT).show();
            break;
